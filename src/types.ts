...
export interface StateChangeInvoke extends StateChangesDetails {
}
...
export interface StateChangesDetails {
  ...
  stateChanges: {
    data: KeyValuePair[]
    transfers: StateChangeTransfer[]
    invokes: StateChangeInvoke[]
  }
}

export interface StateChanges extends StateChangesDetails {
  senderPublicKey: string
  fee: number
  type: number
  version: number
...
export interface StateChangeTransfer {
  address: string
  asset: string | null
  amount: number
}
